...
// even level rising to a crisp waterline, cheer punched clean through — so the fill reads at a glance.
...
const INK = "#100f16"; // the fundraiser screen background — the cheer reads as a hole punched through
  ...
  return (
    <div className={styles.frFill} style={{ width: size, height: size }} aria-hidden>
      ...
      <svg className={styles.frFillLayer} viewBox="0 0 48 48" fill="none">
        ...
        <path d={CHEER} stroke={LINE} strokeWidth="1.3" strokeLinejoin="round" strokeLinecap="round" />
      ...
      {/* collected level: one flat accent fill (no gradient wash), cheer punched out in ink */}
