...
export const BOT_SCENARIOS: BotScenario[] = [
  // ── Needs you ─────────────────────────────────────────────────────────────
  {
    ...
    source: "game-notify · cheer-tasks/append",
    wired: true,
  ...
  },
  {
    ...
    source: "game-notify · cheer-fundraiser-status → delivering",
    wired: true,
  ...
  },
  {
    ...
    source: "game-notify · cheer-tasks/entry → refunded",
    wired: true,
  ...
  },
  {
    ...
    source: "game-notify · cheer-fundraiser-status → refunded",
    wired: true,
  ...
  },
  {
    ...
    source: "not emitted yet",
    wired: false,
    sample: { title: "Best day yet — $340", body: "Your strongest day on Cheer so far." },
  },
  ...
  // ── Summaries ─────────────────────────────────────────────────────────────
  {
    ...
    wired: true,
    sample: { title: "Your month on Cheer", body: "Earned $1,240 from 38 donations." },
  },
  {
    kind: "week_summary",
